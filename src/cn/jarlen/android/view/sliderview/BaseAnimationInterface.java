 ...
 * animation (PagerTransformer) starts or ends.
 * 
 * 
 * There are two items you have to know. The first item is the slider you are
 * dragging. This item I call it Current Item. The second is the slider that
 * gonna to show. I call that Next Item.
 * 
 * When you start to drag the slider in front of you,
 * onPrepareCurrentItemLeaveScreen() and onPrepareNextItemShowInScreen will be
 * called.
 * 
 * When you finish drag, the onCurrentItemDisappear and onNextItemAppear will be
 * invoked.
 * 
